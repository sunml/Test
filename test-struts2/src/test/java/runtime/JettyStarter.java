...
/**
 * 
 * -Xms512m -Xmx1024m -XX:PermSize=128M -XX:MaxPermSize=256M -Xverify:none
 * -server -XX:+UseSerialGC -Dcom.sun.management.jmxremote=true
 * 
...
public class JettyStarter {
	...
	public static void main(String[] args) throws Exception {
		InputStream classPathResource = JettyStarter.class.getClassLoader().getResourceAsStream("jetty.properties");
		Properties properties = new Properties();
		properties.load(classPathResource);

 ...
 * </p>
 * <p>
 * The interface {@link Validator} is the main entry point the BV API. The test
 * makes use of the <code>validate()</code> method of that interface, which
...
public class CarTest {
	...
	public void carIsRented() {
		...
		assertEquals(1, constraintViolations.size());
		assertEquals("Wrong message", "The car is currently rented out", constraintViolations.iterator().next().getMessage());
